...
namespace DataAccess.Migrations
{
    ...
    [Migration("20231104174513_werhgfflkhgj")]
    partial class werhgfflkhgj
    {
            ...
            modelBuilder.Entity("DataAccess.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Create = new DateTime(2023, 11, 4, 21, 45, 13, 48, DateTimeKind.Local).AddTicks(5661),
                            Name = "Admin",
                        ...
                        {
                            ID = 2,
                            Create = new DateTime(2023, 11, 4, 21, 45, 13, 48, DateTimeKind.Local).AddTicks(5730),
                            Name = "User",
                            Update = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Create = new DateTime(2023, 11, 4, 21, 45, 13, 48, DateTimeKind.Local).AddTicks(7390),
                            Email = "naib.ibishov@asb.az",
                            PasswordHash = "Z$����O^��3fnׅ�_�q-�k( +_����",
                            RoleId = 1,
                            Salt = "LmqGkVETaCgdww==",
                            Update = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
